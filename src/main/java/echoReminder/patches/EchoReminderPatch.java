...
public class EchoReminderPatch {
    ...
    private static Texture doubleTexture = TextureLoader.getTexture("echoFormReminderResources/images/double_card.png");
    ...
    public static void Postfix(AbstractCard __instance, SpriteBatch sb){
            if(AbstractDungeon.player != null && !AbstractDungeon.player.drawPile.contains(__instance) && (AbstractDungeon.player.hasPower(EchoPower.POWER_ID)) &&
